...
# clone the driver
$ git clone https://github.com/iamlab-cmu/Universal_Robots_ROS_Driver.git src/Universal_Robots_ROS_Driver

# clone the description. Currently, it is necessary to use the melodic-devel branch.
$ git clone -b lego https://github.com/iamlab-cmu/universal_robot.git src/universal_robot
